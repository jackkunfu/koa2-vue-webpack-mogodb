...
var update = __webpack_require__(22)("58ac5807", content, true);
...
// module
exports.push([module.i, ".team-detail[data-v-64670792]{padding-top:.5rem;padding-bottom:4rem}.team-item[data-v-64670792]{padding:.5rem;border-radius:0}.team-item .img[data-v-64670792]{margin-right:1rem;background:#fff}.team-item .img img[data-v-64670792]{border-radius:.5rem .5rem 0 0}.tags[data-v-64670792]{margin-left:7rem}", ""]);
...
exports.default = {
    ...
    mounted: function mounted() {
        ...
        this.cmFun.ajax('get', '/active', {
            groupId: this.groupId,
            page: this.page,
            rows: 10
        }, function (d) {
            console.log(d);
            _this.ActivityArr = d.list;
    ...
    watch: {
        page: function page(v) {
            ...
            this.cmFun.ajax('get', '/active', {
                ...
                console.log(d);
                _this2.ActivityArr = _this2.ActivityArr.concat(d.list);
                _this2.done = true;
                _this2.show = false;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return _c('div', {
    ...
    }, [_vm._v("报名未开始")]) : _vm._e(), (item.status == 4) ? _c('div', {
      staticClass: "status ing"
    }, [_vm._v("报名中")]) : _vm._e(), (item.status == 5) ? _c('div', {
      staticClass: "status over"
    }, [_vm._v("报名已结束")]) : _vm._e(), (item.status == 1) ? _c('div', {
      staticClass: "status over"
    }, [_vm._v("活动已取消")]) : _vm._e(), (item.status == 7) ? _c('div', {
      staticClass: "status over"
    }, [_vm._v("活动未开始")]) : _vm._e(), (item.status == 8) ? _c('div', {
      staticClass: "status ing"
    }, [_vm._v("活动进行中")]) : _vm._e(), (item.status == 9) ? _c('div', {
      staticClass: "status over"
      ...
      staticClass: "address"
    }, [_vm._v("地点: " + _vm._s(item.address))]), _c('div', {
      staticClass: "tags"
  ...
  }) : _c('div', [_vm._v("没有更多了")])]) : _vm._e(), _c('div', {
    staticClass: "bottom"
  }, [_c('div', {
    staticClass: "cur"
  }, [_c('router-link', {
